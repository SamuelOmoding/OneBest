        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl md:text-6xl font-bold text-gray-800 mb-6">
              ...
              <span className="text-green-700 block">Your Style Story</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Explore & Discover our curated collection of the latest trends in fashion, designed for the modern trendsetter who values quality and style.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                to="/categories"
                className="border-2 border-green-700 text-green-700 px-8 py-2 rounded-full hover:bg-green-700 hover:text-white transition"
              >
